...
const sample = {
  ...
  articles: [
    {
      title:
        '大谷vsジャッジを「MLBは望んでいる」 米記者力説…不可欠なスター激突の"頂上決戦"',
      description:
    ...
    },
    {
      ...
      image:
        "https://basket-count.com/wp-content/uploads/2024/10/yng1002t1.jpg",
      publishedAt: "2024-10-16T03:00:00Z",
      source: { name: "バスケットカウント", url: "https://basket-count.com" },
    },
    {
      title:
        "グリズリーズ番記者に聞く河村勇輝の評価「司令塔としての力量はすでに上質」",
      description:
